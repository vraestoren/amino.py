...
class Amino:
    ...
    def get_from_device_id(self, device_id: str) -> dict:
        return self.session.get(
            f"{self.api}/g/s/auid?deviceId={device_id}", proxies=self.proxies).json()  
    ...
    def get_notifications(self, ndc_id: int, start: int = 0, size: int = 10) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/notification?start={start}&size={size}", proxies=self.proxies).json() 
    ...
    def get_wallet_info(self) -> dict:
        return self.session.get(
            f"{self.api}/g/s/wallet", proxies=self.proxies).json() 
    ...
    def get_wallet_history(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/g/s/wallet/coin/history?start={start}&size={size}", proxies=self.proxies).json() 
    ...
    def my_communities(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/g/s/community/joined?start={start}&size={size}", proxies=self.proxies).json()  
        
    def watch_ad(self) -> dict:
        return self.session.post(
            f"{self.api}/g/s/wallet/ads/video/start", proxies=self.proxies).json() 
    ...
    def join_chat(self, ndc_id: int, chat_id: str) -> dict:
        return self.session.post(
            f"{self.api}/x{ndc_id}/s/chat/thread/{chat_id}/member/{self.user_id}", proxies=self.proxies).json()  
    ...
    def get_chat_messages(
            ...
            size: int = 10) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/chat/thread/{chat_id}/message?v=2&pagingType=t&size={size}", proxies=self.proxies).json() 
         
    def get_chat(self, ndc_id: int, chat_id: str) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/chat/thread/{chat_id}", proxies=self.proxies).json()  
    ...
    def get_banned_users(self, ndc_id: int, start: int = 0, size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/user-profile?type=banned&start={start}&size={size}", proxies=self.proxies).json()  
    ...
    def kick_user(
        ...
        return self.session.delete(
            f"{self.api}/x{ndc_id}/s/chat/thread/{chat_id}/member/{user_id}?allowRejoin={allowRejoin}", proxies=self.proxies).json()   
    ...
    def search_user_chat(
            ...
            user_id: str) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/chat/thread?type=exist-single&cv=1.2&q={user_id}", proxies=self.proxies).json()  
    ...
    def get_chat_users(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/chat/thread/{chat_id}/member&type=default&start={start}&size={size}", proxies=self.proxies).json() 
    ...
    def my_chat_threads(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/chat/thread?type=joined-me&start={start}&size={size}", proxies=self.proxies).json()  
    ...
    def thank_tip(
            ...
            user_id: str) -> dict:
        return self.session.post(
            f"{self.api}/x{ndc_id}/s/chat/thread/{chat_id}/tipping/tipped-users/{user_id}/thank", proxies=self.proxies).json()  

    def get_user(self, ndc_id: int, user_id: str) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/user-profile/{user_id}?action=visit", proxies=self.proxies).json() 
    ...
    def get_tipped_users_wall(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/blog/{blog_id}/tipping/tipped-users-summary?start={start}&size={size}", proxies=self.proxies).json() 
    ...
    def get_online_users(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/live-layer?topic=ndtopic:x{ndc_id}:online-members&start={start}&size={size}", proxies=self.proxies).json()  
    ...
    def get_recent_users(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/user-profile?type=recent&start={start}&size={size}", proxies=self.proxies).json() 
    ...
    def get_from_code(self, code: str) -> dict:
        return self.session.get(
            f"{self.api}/g/s/link-resolution?q={code}", proxies=self.proxies).json() 
    ...
    def get_user_blogs(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/blog?type=user&q={user_id}&start={start}&size={size}", proxies=self.proxies).json() 
         
    def get_community_info(self, ndc_id: int) -> dict:
        return self.session.get(
            f"{self.api}/g/s-x{ndc_id}/community/info?withInfluencerList=1&withTopicList=true&influencerListOrderStrategy=fansCount", proxies=self.proxies).json() 
    ...
    def moderation_history_community(self, ndc_id: int, size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/admin/operation?pagingType=t&size={size}", proxies=self.proxies).json()  
    ...
    def moderation_history_blog(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/admin/operation?objectId={blog_id}&objectType=1&pagingType=t&size={size}", proxies=self.proxies).json()  
    ...
    def moderation_history_quiz(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/admin/operation?objectId={quiz_id}&objectType=1&pagingType=t&size={size}", proxies=self.proxies).json()  
    ...
    def moderation_history_wiki(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/admin/operation?objectId={wiki_id}&objectType=2&pagingType=t&size={size}", proxies=self.proxies).json() 
         
    def give_curator(self, ndc_id: int, user_id: str) -> dict:
        return self.session.post(
            f"{self.api}/x{ndc_id}/s/user-profile/{user_id}/curator", proxies=self.proxies).json()  
    ...
    def clear_notifications(self, ndc_id: int) -> dict:
        return self.session.delete(
            f"{self.api}/x{ndc_id}/s/notification", proxies=self.proxies).json() 
    ...
    def get_recent_blogs(
            ...
            size: int = 10) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/feed/blog-all?pagingType=t&start={start}&size={size}", proxies=self.proxies).json()
    ...
    def follow_user(self, ndc_id: int, user_id: str) -> dict:
        return self.session.post(
            f"{self.api}/x{ndc_id}/s/user-profile/{user_id}/member", proxies=self.proxies).json()
        
    def unfollow_user(self, ndc_id: int, user_id: str) -> dict:
        return self.session.delete(
            f"{self.api}/x{ndc_id}/s/user-profile/{self.user_id}/joined/{user_id}", proxies=self.proxies).json()
    ...
    def get_user_following(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/user-profile/{user_id}/joined?start={start}&size={size}", proxies=self.proxies).json()
    ...
    def get_user_followers(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/user-profile/{user_id}/member?start={start}&size={size}", proxies=self.proxies).json()
    
    def block_user(self, ndc_id: int, user_id: str) -> dict:
        return self.session.post(
            f"{self.api}/x{ndc_id}/s/block/{user_id}", proxies=self.proxies).json()
    ...
    def get_blog_info(self, ndc_id: int, blog_id: str) -> dict:
        return self.session.get(
            f"{self.api}/x{ndc_id}/s/blog/{blog_id}", proxies=self.proxies).json()
    ...
    def get_invite_codes(
            ...
            size: int = 25) -> dict:
        return self.session.get(
            f"{self.api}/g/s-x{ndc_id}/community/invitation?status={status}&start={start}&size={size}", proxies=self.proxies).json()
